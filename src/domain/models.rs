...
use super::format::priority_abbrev;
...
impl Issue {
    /// Compact priority label for the list column (see
    /// [`priority_abbrev`](super::format::priority_abbrev)).
    pub fn priority_label(&self) -> &'static str {
        priority_abbrev(self.priority)
    }
}
